...
const ChooseUsername = ({
  ...
  <div className={accountstyles.usernameinputbox}>
    <input type="text" autoFocus="autoFocus" className={accountstyles.usernameinput} placeholder="Fairdrive User #1263" value={username} onChange={e => setUsername(e.target.value)}/>
  </div>
